    ...
    <section id="Hero">
      <div className="mt-60 text-center ">
        ...
        <div className="text-center mt-15">
          <button className="font-semibold text-lg bg-[#ff914e] text-[#fdf2e9] px-4 py-2 lg:px-8 lg:py-4 rounded-lg transition duration-300 ease-in-out hover:shadow-lg shadow-[#ff914e]/50 cursor-pointer">
            Hemen Dene !
          </button>
        </div>
      </div>
